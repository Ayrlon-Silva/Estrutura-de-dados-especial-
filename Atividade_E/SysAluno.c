...
void prencherDados(aluno *novoAluno);
...
void buscar_por_matricula(aluno *alunos, int qtdAlunos);
void buscar_por_nome(aluno *alunos, int qtdAlunos);
...
void listarAlunos(aluno *alunos, int alunosCadastrados){
    system("cls");
    printf("===================================\n");
...
void editarAluno(aluno *alunos, int alunosCadastrados){
    system("cls");
    printf("\n ====>>> EDITAR ALUNO <<<==== \n");
    int cod;
...
void removerAluno(aluno *alunos, int alunosCadastrados){
    system("cls");
    printf("\n ====>>> REMOVER ALUNO <<<==== \n");
...
void buscar_por_matricula(aluno *alunos, int alunosCadastrados){
    system("cls");
...
void buscar_por_nome(aluno *alunos, int alunosCadastrados){
    system("cls");
    printf("\n ====>>> BUSCAR POR NOME <<<==== \n");
    char nome[120];
